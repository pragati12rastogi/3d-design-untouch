...
if(isset($_POST['form_contact']))
{
    ...
    if($valid == 1)
    {
        ...
        $message = '
<html><body>
<b>Visitor Name:</b><br>'.$visitor_name.'<br><br>
<b>Visitor Email:</b><br>'.$visitor_email.'<br><br>
<b>Visitor Phone:</b><br>'.$visitor_phone.'<br><br>
<b>Visitor Message:</b><br>'.nl2br($visitor_message).'
</body></html>
';
        try {
