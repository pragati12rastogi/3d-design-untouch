		...
		<div class="row">
			<div class="col-md-12">
                ...
                <div class="cart-buttons">
                    <ul>
                        <li><input type="submit" value="<?php echo UPDATE_CART; ?>" class="btn btn-primary" name="form1"></li>
                        <li><a href="index.php" class="btn btn-primary"><?php echo CONTINUE_SHOPPING; ?></a></li>
                        <li><a href="checkout.php" class="btn btn-primary"><?php echo PROCEED_TO_CHECKOUT; ?></a></li>
                    </ul>
                </div>
                </form>
                <?php endif; ?>
