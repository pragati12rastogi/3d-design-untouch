                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo PRODUCT_DETAILS; ?></th>
                                    <th><?php echo PAYMENT_DATE_AND_TIME; ?></th>
                                    <th><?php echo PAID_AMOUNT; ?></th>
                                    <th><?php echo PAYMENT_STATUS; ?></th>
                                    <th><?php echo SHIPPING_STATUS; ?></th>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void;" class="btn btn-danger btn-sm btn-block" style="font-size:14px;"><?php echo $row['payment_status']; ?></a>
                                            <?php elseif($row['payment_status'] == 'Completed'): ?>
                                            <a href="javascript:void;" class="btn btn-success btn-sm btn-block" style="font-size:14px;"><?php echo $row['payment_status']; ?></a>
                                            <?php endif; ?>
                                        </td>
